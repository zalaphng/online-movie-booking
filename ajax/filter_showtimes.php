...
$theaterFilter = "";
if (isset($_GET['theater']) && !empty($_GET['theater'])) {
    $theaterFilter = "AND st.theater_id = '" . mysqli_real_escape_string($conn, $_GET['theater']) . "'";
}

$showtimeQuery = "SELECT t.theater_name, s.screen_name, st.id as showtime_id, st.showtime 
                  FROM showtimes st 
...
$result = mysqli_query($conn, $showtimeQuery);
